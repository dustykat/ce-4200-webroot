...
\texttt{11SEP24} & Aspects of Professionalism   &  \\ %5
\texttt{16SEP24} & ASCE Sustainability & \\ %6 ES-3 (Precipitation, Runoff Data Plots; Oklahoma Empirical Return Period)
\texttt{18SEP24} & WCOE Job Fair (All Engineering)   & Must attend, provide evidence\\ %7
\texttt{23SEP24} & ASCE ENVISIONS &  \\ %8 ES-4 (FloodFrequency B17C)
\texttt{25SEP24} & Basics of the FE &   \\  %9 NOAA Atlas 14, PFDS, Create design storm
\texttt{30SEP24} & FE Review - Transportation &  \\ % XBS Watershed Delineation; Flood Frequency; Water Budget; 
\texttt{~2OCT24} & FE Review - Geotech & Dr. Yimin Lu\\ %10
...
\texttt{21OCT24} & FE Review - Statics  & Dr. Sanwook Bae \\ %15
\texttt{23OCT24} & FE Review - Fluids & \\ %16
\texttt{28OCT24} & FE Review - Hydrology &\\ %17
\texttt{30OCT24} & FE Review - Materials & Dr. Moon Won \\ %18
\texttt{~4NOV24} & FE Review - Dynamics &  \\ %19
\texttt{~6NOV24} & FE Review - Q\&A  &  \\ %20
\texttt{11NOV24} & Qualification Based Selection &  \\ %21 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\texttt{13NOV24} & Project Management &  \\ %22
\texttt{18NOV24} & Leadership &  \\ %23
\texttt{20NOV24} & Engineering Judgement &  \\ %24
\texttt{25NOV24} & Critical Thinning &  \\ %25
\texttt{28NOV24} & Thanksgiving Holiday &    \\ %26
\texttt{~2DEC24} & Summary & Teams 4-8 \\ %27
