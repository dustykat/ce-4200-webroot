...
\hline
\texttt{15 Jan 25} & Introduction &   \\ %1
\texttt{17 Jan 25} & ASCE BOK &  \cite{ASCE2019}\\ %2 
\texttt{20 Jan 25} & MLK Holiday & No Meeting \\% 
\texttt{22 Jan 25} & ABET Breath Elements & \cite{ASCE2019} \\% 3
\texttt{27 Jan 25} & Public Health Considerations &  \cite{ASCE2019} \\ %4
\texttt{29 Jan 25} & Safety Considerations &  \cite{ASCE2019} \\ %5
\texttt{03 Feb 25} & Welfare Considerations &  \cite{ASCE2019} \\ %6
\texttt{05 Feb 25} & Future Expectations as an Engineer & \\ %7
\texttt{10 Feb 25} & Attitude and Career Guidance &  \cite{Attitude2024} \\ %8
\texttt{12 Feb 25} & Job Fair &  Attend Both Days \\ %8
\texttt{17 Feb 25} & Global Considerations &  \cite{ASCE2019} \\ %9
\texttt{19 Feb 25} & Cultural Considerations &  \cite{ASCE2019} \\ %10
\texttt{24 Feb 25} & Social Considerations &  \cite{ASCE2019} \\ %11
\texttt{26 Feb 25} & Environmental Considerations &  \cite{ASCE2019} \\ %12
\texttt{03 Mar 25} & Economic Considerations &  \cite{ASCE2019} \\ %13
\texttt{05 Mar 25} & Sustainability & ASCE ENVISIONS \cite{ASCE2019} \\ %14
\hline
\texttt{10 Mar 25} & Aspects of Professionalism   &  \cite{Lawson2004}\\ %16
\texttt{12 Mar 25} & FE Review - Licensing & \cite{TEPA2021}\\ %17 
\texttt{26 Mar 25} & FE Review - Transportation & Dr. Liu \cite{NCEES2020}  \cite{Lindeburg2017}\\ %18
\texttt{31 Mar 25} & FE Review - Geotech & Dr. Lu \cite{NCEES2020}  \cite{Lindeburg2017}\\ %19
\texttt{02 Apr 25} & FE Review - Structural & Dr. Park \cite{NCEES2020} \cite{Lindeburg2017}\\ %20#
\texttt{07 Apr 25} & FE Review - Hydrology & Dr. Cleveland \cite{NCEES2020} \cite{Lindeburg2017}\\  %21
\texttt{09 Apr 25} & ASCE Ethics Example, Sara's story  & Dr. Cleveland \cite{ASCE2019}\\ %22
\texttt{14 Apr 25} & FE Review - Construction &  Dr. Deng \cite{NCEES2020}  \cite{Lindeburg2017}\\ %23
\texttt{16 Apr 25} & FE Review - Statics  & Dr. Bae \cite{NCEES2020}  \cite{Lindeburg2017}\\ %24
\texttt{21 Apr 25} & FE Review - Fluids & Dr. Fei \cite{NCEES2020}  \cite{Lindeburg2017}\\ %25
\texttt{23 Apr 25} & FE Review - Mechanics of Materials & Dr. Cleveland \cite{NCEES2020} \cite{Lindeburg2017}\\ %26#
\texttt{23 Apr 25} & FE Review - Materials Science & Dr. Cleveland \cite{NCEES2020} \cite{Lindeburg2017}\\ %26.1#
\texttt{28 Apr 25} & FE Review - Materials & Dr. Won \cite{NCEES2020}  \cite{Lindeburg2017}\\ %27
\texttt{30 Apr 25} & FE Review - Dynamics & Dr. Cleveland \cite{NCEES2020}  \cite{Lindeburg2017}\\ %28#
\texttt{05 May 25} & FE Review - Environmental  & Dr. Gray \cite{NCEES2020}  \cite{Lindeburg2017}\\ %29
\texttt{12 May 25} & \textbf{Final Exam} & \url{https://www.depts.ttu.edu/officialpublications/class_schedule/spring_class.php} \\ %ZBS Storm Sewer; Routing ; HEC-HMS; Pumping Test; Wellfield
\hline
   \end{tabular}
