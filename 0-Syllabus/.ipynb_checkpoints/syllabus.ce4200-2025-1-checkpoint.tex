...
\hline
\texttt{DDMMMYY} & Introduction &   \\ %0
\texttt{DDMMMYY} & ASCE BOK &  \cite{ASCE2019}\\ %1 
\texttt{DDMMMYY} & ABET Breath Elements & \cite{ASCE2019} \\% 3
\texttt{DDMMMYY} & Public Health Considerations &  \cite{ASCE2019} \\ %4(1)
\texttt{DDMMMYY} & Safety Considerations &  \cite{ASCE2019} \\ %5(2)
\texttt{DDMMMYY} & Welfare Considerations &  \cite{ASCE2019} \\ %6(3)
\texttt{DDMMMYY} & Global Considerations &  \cite{ASCE2019} \\ %7(4)
\texttt{DDMMMYY} & Cultural Considerations &  \cite{ASCE2019} \\ %8(5)
\texttt{DDMMMYY} & Social Considerations &  \cite{ASCE2019} \\ %9(6)
\texttt{DDMMMYY} & Environmental Considerations &  \cite{ASCE2019} \\ %10(7)
\texttt{DDMMMYY} & Economic Considerations &  \cite{ASCE2019} \\ %11(8)
\texttt{DDMMMYY} & Sustainability & ASCE ENVISIONS \cite{ASCE2019} \\ %12(9)
...
\texttt{25SEP24} & FE Review - Licensing & Dr. Cleveland \cite{TEPA2021} \\  %9 
...
\texttt{~9OCT24} & FE Review - Hydrology & Dr. Cleveland \cite{NCEES2020} \cite{Lindeburg2017}\\  %12  
...
\texttt{28OCT24} & FE Review - Mechanics of Materials & Dr. Cleveland \cite{NCEES2020} \cite{Lindeburg2017}\\ %17
\texttt{30OCT24} & FE Review - Materials & Dr. Moon Won \cite{NCEES2020}  \cite{Lindeburg2017}\\ %18
\texttt{~4NOV24} & FE Review - Dynamics & Dr. Cleveland \cite{NCEES2020}  \cite{Lindeburg2017}\\ %19
...
\texttt{13NOV24} & Evaluation of Safety Considerations &  \cite{ASCE2019} \\ %22
%\texttt{18NOV24} & Project Management &  \cite{Lawson2022PM} \\ %23
\texttt{18NOV24} & Evaluation of Public Health Considerations &  \cite{ASCE2019}  \\ %23
