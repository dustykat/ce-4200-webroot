...
\texttt{28AUG24} & Review ASCE BOK &  \\ %1 
\texttt{~4SEP24} & Future Expectations as an Engineer & \\ %3 streamflow measurement, precipitation measurement, online archives
\texttt{~9SEP24} & Attitude and Career Guidance &  \\ %4 watershed definitions and delineation, metrics of interest ES-2 (Watershed Delineation; Web Soil SUrvey)
\texttt{11SEP24} & ASCE Sustainability, ENVISIONS &  \\ %5
\texttt{16SEP24} & Aspects of Professionalism  & \\ %6 ES-3 (Precipitation, Runoff Data Plots; Oklahoma Empirical Return Period)
\texttt{18SEP24} & WCOE Job Fair (All Engineering)   & Must attend, provide evidence\\ %7
\texttt{23SEP24} & Basics of the FE &  \\ %8 ES-4 (FloodFrequency B17C)
\texttt{25SEP24} & FE Review - Materials &   \\  %9 NOAA Atlas 14, PFDS, Create design storm
\texttt{30SEP24} & FE Review - Transportation &  \\ % XBS Watershed Delineation; Flood Frequency; Water Budget; 
\texttt{~2OCT24} & FE Review - Geotech & \\ %10
\texttt{~7OCT24} & FE Review - Structural & \\ %11
\texttt{~9OCT24} & FE Review - Mechanics of Materials &  \\  %12  
\texttt{14OCT24} & ASCE Ethics Example, Sara's story  & \\ %13
\texttt{16OCT24} & FE Review - Construction &  \\ %14
\texttt{21OCT24} & HEC-HMS  & SN \\ %15
\texttt{23OCT24} & Reservoir Routing &RSG(pp.477-492;503-506);CMM(pp.242-252)  \\ %16
\texttt{28OCT24} & Catchment Routing &RSG(pp.497-502);CMM(pp.257-272;302-310)\\ %17
\texttt{30OCT24} & Reservoir Storage and Discharge & RSG(pp.545-575)\\ %18
\texttt{~4NOV24} & H\&H - Storm Sewer Sizing &RSG(pp.711-734);CMM(pp.493-517)  \\ %19
\texttt{~6NOV24} & H\&H Design - Culvert Sizing & RSG(pp.761-770);CMM(pp.XXX-XXX)  \\ %20
\texttt{11NOV24} & Groundwater Hydrology & RSG(pp.127-135)  \\ %21 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\texttt{13NOV24} & Groundwater Flow Mechanics & RSG(pp.136-154) \\ %22
\texttt{18NOV24} & Well Hydraulics & RSG(pp.167-187) \\ %23
\texttt{20NOV24} & Pumping Tests & RSG(pp.187-215) \\ %24
\texttt{25NOV24} & Team Presentations &  Teams 1-4\\ %25
\texttt{28NOV24} & Thanksgiving Holiday &    \\ %26
\texttt{~2DEC24} & Team Presentations & Teams 4-8 \\ %27
